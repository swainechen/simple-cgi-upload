...
my @test_cases = (
    ...
    { file => 'attack.txt', dir => '../cgi-bin', expected => 'Invalid directory format', desc => 'Path traversal (parent dir)' },
    ...
    { file => 'valid.txt', dir => 'incoming', expected => '<meta name="robots" content="noindex, nofollow">', desc => 'Meta Tag: robots' },
    { file => 'valid.txt', dir => 'incoming', expected => '<meta name="referrer" content="no-referrer">', desc => 'Meta Tag: referrer' },
    { file => 'script.php', dir => 'incoming', expected => 'Status: 403 Forbidden', desc => 'Error Status: 403 Forbidden' },
    { file => 'script.php', dir => 'incoming', expected => '<meta name="robots" content="noindex, nofollow">', desc => 'Error Meta Tag: robots' },
    { file => 'valid.txt', dir => 'invalid-dir!', expected => 'Status: 400 Bad Request', desc => 'Hardened dir: invalid characters' },
    { file => 'valid.txt', dir => 'invalid-dir!', expected => 'Invalid directory format', desc => 'Hardened dir: error message' },
    { file => 'valid.txt', dir => 'a' x 65, expected => 'Status: 400 Bad Request', desc => 'Hardened dir: too long' },
